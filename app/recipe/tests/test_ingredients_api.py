...
def detail_url(ingredient_id):
    """Create adn return an ingredient detail URL """
...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredients(self):
        """Test retrieve a set of ingredients"""
    ...
    def test_filter_ingredient_assigned_to_recipes(self):
        ...
        in2 = Ingredient.objects.create(user=self.user, name='Turkeys')
    ...
    def test_filtered_ingredients_unique(self):
        """Test filtered unique return a unique list"""
